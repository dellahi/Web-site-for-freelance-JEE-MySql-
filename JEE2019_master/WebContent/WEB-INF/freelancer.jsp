            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" action="Inscription">
                        	<div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="prix"  placeholder="Your Price"required=""/>
                            </div>
                            
                            <div class="form-group">
                                <label for="Apropos"><i class="zmdi zmdi-comment-alt-text"></i></label>
                                <input type="text" name="Apropos"  placeholder="About you"required=""/>
                            </div>
