...
public class Applyproject extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/applyproject.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Postuler ps = new Postuler();
		
		ps.setUsername(request.getParameter("Username"));
        ps.setTitre(request.getParameter("titre"));
        
        PostulerBd pb = new PostulerBd();
        pb.postuler(ps);
